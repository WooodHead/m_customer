<template>
	<div class="vux-x-input weui-cell" :class="{'weui-cell_warn': !valid,'active':isFocus}">
    <div class="weui-cell__hd h-center mr30">
    ...
    <div class="weui-cell__bd weui-cell__primary h-center">
      <input
      v-if="!type || type === 'text'"
      class="weui-input"
      :maxlength="max"
...
.vux-x-input .input-label{
 display: inline-block;
}

.vux-x-input .input-label-active{
  display:none;
}
.vux-x-input.active .input-label{
  display:none;
}
.vux-x-input.active .input-label-active{
  display:inline-block;
}
.vux-x-input.active.weui-cell::before{
  border-color:#ff6600;
}
